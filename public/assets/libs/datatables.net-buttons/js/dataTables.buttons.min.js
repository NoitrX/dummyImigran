...
!(function (e) {
  ...
  function k(n, t) {
    ...
    !0 === (t = void 0 === t ? {} : t) && (t = {}),
      ...
      (this.dom = { container: v("<" + this.c.dom.container.tag + "/>").addClass(this.c.dom.container.className) }),
      this._constructor();
  }
  v.extend(k.prototype, {
                ...
                if (((p.collection = v("<" + (l ? this.c.dom.splitCollection : this.c.dom.collection).tag + "/>")), (p.conf._collection = p.collection), p.conf.split))
                  for (var h = 0; h < p.conf.split.length; h++)
                    "object" == typeof p.conf.split[h] &&
                      ...
                      p.conf.split[h].collectionLayout === x && (p.conf.split[h].collectionLayout = p.conf.collectionLayout),
                      p.conf.split[h].dropup === x && (p.conf.split[h].dropup = p.conf.dropup),
                      p.conf.split[h].fade === x && (p.conf.split[h].fade = p.conf.fade));
    ...
    _buildButton: function (n, t, e, o) {
      ...
      if (n.spacer)
        return (
          (r = v("<span></span>")
            ...
            .html(i(n.text))),
          { conf: n, node: r, inserter: r, buttons: [], inCollection: t, isSplit: e, inSplit: o, collection: null }
        );
      if ((!e && o && f ? (u = p) : !e && t && d.button && (u = d.button), !e && o && f.buttonLiner ? (c = f.buttonLiner) : !e && t && d.buttonLiner && (c = d.buttonLiner), n.available && !n.available(h, n) && !n.hasOwnProperty("html")))
        return !1;
      ...
      return (
        ...
        e &&
          ...
          (y = v('<button class="' + this.c.dom.splitDropdown.className + ' dt-button"><span class="dt-btn-split-drop-arrow">' + this.c.dom.splitDropdown.text + "</span></button>")
            .on("click.dtb", function (t) {
        ...
        { conf: n, node: (e ? b : l).get(0), inserter: e ? b : d, buttons: [], inCollection: t, isSplit: e, inSplit: o, collection: null }
      );
    },
        ...
        (a = function (t) {
          for (var n, e, o = 0, i = t.length; o < i; o++)
            (n = t[o].conf),
              (e = t[o].node),
              !n.key ||
                (n.key !== s && (!v.isPlainObject(n.key) || n.key.key !== s || (n.key.shiftKey && !r.shiftKey) || (n.key.altKey && !r.altKey) || (n.key.ctrlKey && !r.ctrlKey) || (n.key.metaKey && !r.metaKey))) ||
    ...
    _popover: function (o, t, n, e) {
      function i() {
        (h = !0),
          ...
          v(f.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr("aria-expanded", "false"),
      ...
      !1 === o
        ? i()
        : ((p = v(f.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes())).length && (g.closest("div.dt-button-collection").length && (g = p.eq(0)), i()),
          (n = v(".dt-button", o).length),
          (p = ""),
          3 === n ? (p = "dtb-b3") : 2 === n ? (p = "dtb-b2") : 1 === n && (p = "dtb-b1"),
          (s = v("<div/>").addClass("dt-button-collection").addClass(b.collectionLayout).addClass(b.splitAlignClass).addClass(p).css("display", "none").attr({ "aria-modal": !0, role: "dialog" })),
          ...
          b.closeButton && s.prepend('<div class="dtb-popover-close">x</div>').addClass("dtb-collection-closeable"),
          _(s.insertAfter(g), b.fade),
          (n = v(t.table().container())),
          (d = s.css("position")),
          ("container" !== b.span && "dt-container" !== b.align) || ((g = g.parent()), s.css("width", n.width())),
          "absolute" === d
            ? ((p = v(g[0].offsetParent)),
              ...
              ("button-right" !== b.align && !s.hasClass(b.rightAlignClassName)) || (u = t.left - c.width + g.outerWidth()),
              ("dt-container" !== b.align && "container" !== b.align) || ((u = u < t.left ? -t.left : u) + c.width > r.width && (u = r.width - c.width)),
          ...
          b.background && k.background(!0, b.backgroundClassName, b.fade, b.backgroundHost || g),
    ...
    (k.buttonSelector = function (t, n) {
      for (
        var u = [],
          c = function (t, n, e) {
            for (var o, i, s = 0, r = n.length; s < r; s++) (o = n[s]) && (t.push({ node: o.node, name: o.conf.name, idx: (i = e !== x ? e + s : s + "") }), o.buttons && c(t, o.buttons, i + "-"));
          },
          d = function (t, n) {
            var e = [],
              o =
            ...
            if (Array.isArray(t) || t instanceof v) for (s = 0, r = t.length; s < r; s++) d(t[s], n);
            else if (null === t || t === x || "*" === t) for (s = 0, r = e.length; s < r; s++) u.push({ inst: n, node: e[s].node });
            else if ("number" == typeof t) n.s.buttons[t] && u.push({ inst: n, node: n.s.buttons[t].node });
            else if ("string" == typeof t)
              if (-1 !== t.indexOf(",")) for (var i = t.split(","), s = 0, r = i.length; s < r; s++) d(i[s].trim(), n);
                ...
                for (s = 0, r = e.length; s < r; s++) e[s].name === l && u.push({ inst: n, node: e[s].node });
              } else
                v(o)
                  .filter(t)
                  .each(function () {
            ...
            else "object" != typeof t || !t.nodeName || (-1 !== (a = v.inArray(t, o)) && u.push({ inst: n, node: o[a] }));
          },
          e = 0,
          o = t.length;
        e < o;
    ...
    (k.stripData = function (t, n) {
      return (
        "string" == typeof t &&
          ...
          (n && !n.decodeEntities) || ((l.innerHTML = t), (t = l.value))),
        t
      );
    }),
    (k.defaults = {
    ...
    e.Api.register("buttons.exportInfo()", function (t) {
      return { filename: n((t = t || {})), title: r(t), messageTop: a(this, t.message || t.messageTop, "top"), messageBottom: a(this, t.messageBottom, "bottom") };
    });
  var i,
    n = function (t) {
      var n;
      return (n = "function" == typeof (n = "*" === t.filename && "*" !== t.title && t.title !== x && null !== t.title && "" !== t.title ? t.title : t.filename) ? n() : n) === x || null === n
        ? null
        : (n = (n = -1 !== n.indexOf("*") ? n.replace("*", v("head > title").text()).trim() : n).replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "")) + (s(t.extension) || "");
    },
    s = function (t) {
    ...
    u = function (e, t) {
      for (
        var o = v.extend(
          ...
          i = (e.select && "function" == typeof e.select.info && i.selected === x && e.rows(o.rows, v.extend({ selected: !0 }, i)).any() && v.extend(i, { selected: !0 }), e.rows(o.rows, i).indexes().toArray()),
