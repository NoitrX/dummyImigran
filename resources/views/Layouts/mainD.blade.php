...
<html lang="en">
    ...
    <body data-layout="horizontal">
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Alroyyan.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by <a href="#!" class="text-decoration-underline">Alroyyan</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{asset('assets/js2/metisMenu.min.js')}}"></script>
        <script src="{{asset('assets/js2/simplebar.min.js')}}"></script>
        <script src="{{asset('assets/js2/waves.min.js')}}"></script>
        <script src="{{asset('assets/js2/feather.min.js')}}"></script>
        <!-- pace js -->
        <script src="{{asset('assets/js2/pace.min.js')}}"></script>

        <!-- apexcharts -->
        <script src="{{asset('assets/js2/apexcharts.min.js')}}"></script>
